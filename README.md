...
- Exercises / *Ejercicios*
  ...
  - [E006-CalculadoraApp](#calculadoraapp)
  - [E007-ListadoPersonasApp](#listadopersonasapp)
...
- Projects / *Proyectos*
  ...
  - [P004-VentasPCsApp](#ventaspcsapp)
...
## E005-TemperaturaCiudades
**(Intellij 2023/JDK 21)**

Exercise to load vectors of cities, their minimum and maximum temperatures, and display on screen different conditions such as: the city with the lowest temperature and which one with the next highest temperature (while also indicating the amount of degrees).

*Ejercicio para cargar vectores de ciudades, sus temperaturas mínimas y máximas y mostrar en pantalla distintas condiciones tales como: la ciudad con la temperatura más baja y cual con la siguiente temperatura más alta (dando a conocer al mismo tiempo la cantidad de grados).*

## E006-CalculadoraApp
**(Intellij 2023/JDK 21)**

Creation of an app to input values on-screen and select the operation (+, -, ×, /) to perform, in order to display the corresponding result.

*Creación de app para introducir valores por pantalla y seleccionar la operación (+,-,x,/) a realizar, para así mostrar el resultado correspondiente.*

## E007-ListadoPersonasApp
**(Intellij 2023/JDK 21)**

Exercise to apply the concept of Classes and Objects, use of Lists, and thus reinforce each concept studied up to this point.

*Ejercicio para aplicar el concepto de Clases y Objetos, uso de Listas y así reforzar cada concepto estudiando hasta el momento.*

## E101-PokeJuego
**(Intellij 2022/JDK 11)**
...
API through which, by sending the 3 grades of a subject, obtains as a response the average of them. For passing grades as parameters, use the annotation  \@RequestParam.

*API mediante la cual, al enviar las 3 notas de una materia obtenga como respuesta el promedio de la misma. Para el pasaje de notas como parámetro utilizar la annotation \@RequestParam.*

## E302-EstaturasBasquet
**(Netbeans 12.3 /JDK 11)**

API to immediately obtain as a response the average height of all its entered players.

*API para obtener inmediatamente como respuesta el promedio de estatura de todos sus 
jugadores ingresados.*

## E303-AreaTriangulo
**(Netbeans 12.3 /JDK 11)**

API that allows obtaining the area of a triangle as a response to a GET request.

*API que permita obtener como response a una solicitud GET el área de un triángulo.*

## P001-Copiadora
**(Netbeans 12.3 /JDK 11)**

GUI project that generates a data copier using the MVC pattern.

*Proyecto IGU que genera una copiadora de datos usando el patrón MVC*.

## P002-AgendaElectronica
**(Netbeans 12.3 /JDK 11)**

Demo of an electronic agenda that allows entering user data and storing it in a fictional database.

*Demo de agenda electrónica que permite ingresar datos de usuario y almacenarlos en una base de datos ficticia.*

## P003-ArbolitoNavidad
**(Netbeans 12.3 /JDK 11)**

Create a Christmas tree by specifying the number of rows to be entered.

*Crear un arbolito de navidad al indicar las filas que se desea ingresar.*

## P0004-VentasPCsApp
**(Intellij 2023/JDK 21)**

Computer Sales Application based on a UML Class Diagram, creating classes, objects, as well as the relationship between classes, and many more topics.

*Aplicación de Venta de Computadoras basado en un diagrama de Clases de UML, creando clases, objetos, así como la relación entre clases y muchos temas más.*

## P101-PeluqueriaCanina
**(Netbeans 12.3/JDK 11)**

Emulator project of a canine hair salon that stores data of pets/clients. This is done in the GUI with JPA/EclipseLink.

*Proyecto emulador de una peluquería canina que almacena datos de las mascotas/clientes. Esto se realiza en la IGU con JPA/EclipseLink.*

## P102-ConcesionariaAutos
**(Netbeans 12.3/JDK 11)**

System for a car store that allows loading, reviewing, modifying, and deleting cars from the database. Car data such as license plate, number of doors, model, brand, and others are included. This is done in the GUI with JPA/EclipseLink.

*Sistema para una tienda de autos que permita cargar, revisar, modificar y eliminar autos de la base de datos. Se incluyen datos del auto como patente, cantidad de puertas, modelo, marca y otros. Esto se realiza en la IGU con JPA/EclipseLink.*

## P103-Login
**(Netbeans 12.3/JDK 11)**

*Login demo including username and password. This is done in the GUI with JPA/EclipseLink.*

*Demo de login incluyendo nombre del user y password. Esto se realiza en la IGU con JPA/EclipseLink.*
...
Spring Boot project to query the data of dishes from a restaurant menu by providing the dish number.
