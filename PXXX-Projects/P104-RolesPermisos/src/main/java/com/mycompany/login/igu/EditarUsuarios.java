...
public class EditarUsuarios extends javax.swing.JFrame {
    ...
    public EditarUsuarios(ControladoraLogica control, int id_user) {
        initComponents();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        System.out.println("info a guardar");
        System.out.println(usuario);
        System.out.println(password);
        System.out.println(rolInput);
        
        control.editarUser(usu, usuario, password, rolInput);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        //busco el usuario
        usu = control.traerUsuario(id_user);
        
        //cargamos datos en la interfaz
        txtUser.setText(usu.getNombreUser());
        ...
        //vamos con el rol, recorremos los roles y si coincide lo vamos a 
        //seleccionar y quedará marcado en el form
        ...
        System.out.println("Info leida:");
        System.out.println(usu.getNombreUser());
